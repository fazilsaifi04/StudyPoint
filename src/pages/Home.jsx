  ...
  return (
    <div>
      ...
      <div className="mx-auto relative flex flex-col w-11/12 items-center justify-between text-white">
        ...
        <div className="relative w-[70%] mx-3 my-12 shadow-lg shadow-blue-200">
          <div className="grad2 absolute top-[-2.5rem] max-w-lg w-full"></div>
          <video className="w-full rounded-lg shadow-md" muted loop autoPlay>

  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {loading ? (
        ...
        <div className="mt-6">
          <div className="flex flex-col md:flex-row md:h-[450px] space-y-6 md:space-y-0 md:space-x-4">
            ...
            <div className="flex-1 min-w-[250px] flex flex-col rounded-md bg-richblack-800 p-6">
